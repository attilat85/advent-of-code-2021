...
func part1(input: String) -> Int {
    let lines = input.split(separator: "\n").compactMap({ $0.split(separator: "|").map({ String($0) }) })
...
let lightPatterns = [ 0: "abcefg", 1: "cf", 2: "acdeg", 3: "acdfg", 4: "bcdf", 5: "abdfg", 6: "abdefg", 7: "acf", 8: "abcdefg", 9: "abcdfg"]
let lightPatternsArray = [ "abcefg","cf", "acdeg", "acdfg", "bcdf", "abdfg", "abdefg", "acf", "abcdefg", "abcdfg"]
func part2(input: String) {
    ...
    for line in lines {
        ...
        words.forEach { subString in
            print("-->", String(subString.sorted()))
            var filteredArra = lightPatternsArray
            subString.forEach { character in
                filteredArra = filteredArra.filter({ $0.contains(character) })
            }
            print("filter: ", filteredArra )
        }
        print("---------------------")
...
print("Part 1")
print("Test input: ", part1(input: testInput))
print("Result: ", part1(input: input))
print("---------------------")

//part2(input: testInput)
//: [Next](@next)
